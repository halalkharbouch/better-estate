          ...
          <form className="flex flex-col gap-5">
            ...
            <div className="flex gap-3">
              <div className="flex gap-2 items-center">
                ...
                <input name="furnished" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.furnished} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Air Conditiong</label>
                <input name="airConditioning" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.airConditioning} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Fire Place</label>
                <input name="firePlace" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.firePlace} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Elevator</label>
                <input name="elevator" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.elevator} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Ventilation</label>
                <input name="ventilation" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.ventilation} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Intercom</label>
                <input name="intercom" className="size-5" type="checkbox"
                onChange={handleChange}
            ...
            <div className="flex gap-3">
              ...
              <div className="flex gap-2 items-center">
                ...
                <input name="internet" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.internet} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Garage</label>
                <input name="garage" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.garage} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Pet Friendly</label>
                <input name="petFriendly" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.petFriendly} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Pool</label>
                <input name="pool" className="size-5" type="checkbox"
                onChange={handleChange}
                value={formData.pool} />
              </div>
              <div className="flex gap-2 items-center">
                <label className="text-lg">Cable Tv</label>
                <input name="cableTv" className="size-5" type="checkbox"
                onChange={handleChange}
